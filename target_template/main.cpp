...
core::A4957_driver::A4957
a4957(
    Module::pwm,
    Module::hbridge_in1,
    Module::hbridge_in2,
    Module::hbridge_reset,
    Module::hbridge_fault
);


core::A4957_driver::A4957_SignMagnitude hbridge("hbridge", a4957);
...
using PWM_Subscriber = core::actuator_subscriber::Subscriber_<core::A4957_driver::A4957_SignMagnitude>;
